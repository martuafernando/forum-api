...
describe('DeleteReplyCommentUseCase', () => {
  ...
  it('should throw NotFound Error the user is not found', async () => {
    // Arrange
    const useCasePayload = {
  ...
  it('should throw NotFound Error the thread is not found', async () => {
    // Arrange
    const useCasePayload = {
      commentId: 'comment-123',
      content: 'comment-content',
  ...
  it('should throw NotFound Error the thread comment is not found', async () => {
    // Arrange
    const useCasePayload = {
      commentId: 'comment-123',
      content: 'comment-content',
  ...
  it('should throw NotFound Error the reply comment is not found', async () => {
    // Arrange
    const useCasePayload = {
      commentId: 'comment-123',
      content: 'comment-content',
  ...
  it('should throw Authorization Error the user is not the owner', async () => {
    // Arrange
    const useCasePayload = {
      commentId: 'comment-123',
      content: 'comment-content',
